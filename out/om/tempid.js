...
om.tempid.TempId.cljs$lang$ctorPrWriter = (function (this__17817__auto__,writer__17818__auto__,opt__17819__auto__){
return cljs.core._write.call(null,writer__17818__auto__,"om.tempid/TempId");
});
...
var args20168 = [];
var len__18277__auto___20171 = arguments.length;
var i__18278__auto___20172 = (0);
while(true){
if((i__18278__auto___20172 < len__18277__auto___20171)){
args20168.push((arguments[i__18278__auto___20172]));

var G__20173 = (i__18278__auto___20172 + (1));
i__18278__auto___20172 = G__20173;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args20168.length)].join('')));
